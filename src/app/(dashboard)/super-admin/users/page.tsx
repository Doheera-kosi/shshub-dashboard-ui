...
const UserManagementPage = () => {
  ...
  const users = [
    { id: 1, fullName: 'John Doe', email: 'john.doe@example.com', role: 'Admin', status: 'Active', dateCreated: '2023-01-15' },
    { id: 2, fullName: 'Jane Smith', email: 'jane.smith@example.com', role: 'Editor', status: 'Inactive', dateCreated: '2023-02-20' },
    { id: 3, fullName: 'Sam Wilson', email: 'sam.wilson@example.com', role: 'Viewer', status: 'Active', dateCreated: '2023-03-10' },
  ];
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {users.map((user) => (
              <tr key={user.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap">{user.dateCreated}</td>
                ...
                <div className="mt-2">
                  <form>
                    ...
                    <div className="mb-4">
                      ...
                      <select id="role" name="role" className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                        <option>Admin</option>
